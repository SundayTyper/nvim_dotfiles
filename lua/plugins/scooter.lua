-- Scooter - Interactive find-and-replace terminal UI

-- Scooter terminal state
local scooter_term = nil

-- Called by scooter to open the selected file at the correct line
...
return {
  {
    ...
    optional = true,
    keys = {
      { "<leader>cs", open_scooter, desc = "Open Scooter" },
      {
        "<leader>cS",
        function()
        ...
        mode = "v",
        desc = "Search Selected in Scooter",
      },
    },
  },
}
